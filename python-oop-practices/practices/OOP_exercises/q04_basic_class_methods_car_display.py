...
# Step 4: Add the display_info method
# ===============================================================================

# Explanation:
# Now let's add the display_info method that prints the car's make, model, and year.
# This method will use the attributes we defined earlier to display the car details.
...
# What we accomplished in this step:
# - Added the display_info method with its functionality
